...
parameters (f : RawImp' nm -> RawImp' nm)
  ...
  mapImpDecl (IData fc header dat) = IData fc header (mapImpData dat)
  ...
  mapImpDecl (IRecord fc mstr header rec) = IRecord fc mstr header (mapImpRecord rec)
  ...
  mapTTImp (IBindingApp fc binder pat bound scope) = f $ IBindingApp fc binder (mapTTImp pat) (mapTTImp bound) (mapTTImp scope)
