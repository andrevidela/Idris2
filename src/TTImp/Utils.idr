...
rawImpFromDecl decl = case decl of
    ...
    IRecord fc1 y _ (MkImpRecord fc n params opts conName fields) => do
...
mutual
  ...
  substNamesDecl' bvar bound ps (IData fc hd d)
      = IData fc hd (substNamesData' bvar bound ps d)
...
mutual
  ...
  substLocDecl fc' (IData fc hd d)
      = IData fc' hd (substLocData fc' d)
