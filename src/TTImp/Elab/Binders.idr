...
export
checkCustomBinder : Name -> (info : BinderInformation RawImp) -> (scope : RawImp) -> Maybe (Glued vars) -> Core (Term vars, Glued vars)
checkCustomBinder binder binderInfo scope exp = ?checkCustomBinder_rhs
