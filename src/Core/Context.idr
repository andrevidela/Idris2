...
export
toFullNames : {auto c : ReadOnly Ctxt Defs} ->
              HasNames a => a -> Core a
toFullNames t
    = do defs <- read Ctxt
         full (gamma defs) t
...
export
toResolvedNames : {auto c : ReadOnly Ctxt Defs} ->
                  HasNames a => a -> Core a
toResolvedNames t
    = do defs <- read Ctxt
...
export
getFullName : {auto c : ReadOnly Ctxt Defs} ->
              Name -> Core Name
...
export
getPPrint : {auto c : ReadOnly Ctxt Defs} ->
            Core PPrinter
getPPrint
    = do defs <- read Ctxt
...
export
isPairType : {auto c : ReadOnly Ctxt Defs} ->
             Name -> Core Bool
isPairType n
    = do defs <- read Ctxt
...
export
fstName : {auto c : ReadOnly Ctxt Defs} ->
          Core (Maybe Name)
fstName
    = do defs <- read Ctxt
...
export
sndName : {auto c : ReadOnly Ctxt Defs} ->
          Core (Maybe Name)
sndName
    = do defs <- read Ctxt
...
export
getRewrite :{auto c : ReadOnly Ctxt Defs} ->
            Core (Maybe Name)
getRewrite
    = do defs <- read Ctxt
...
export
isEqualTy : {auto c : ReadOnly Ctxt Defs} ->
            Name -> Core Bool
isEqualTy n
    = do defs <- read Ctxt
...
export
fromIntegerName : {auto c : ReadOnly Ctxt Defs} ->
                  Core (Maybe Name)
fromIntegerName
    = do defs <- read Ctxt
...
export
fromStringName : {auto c : ReadOnly Ctxt Defs} ->
                 Core (Maybe Name)
fromStringName
    = do defs <- read Ctxt
...
export
fromCharName : {auto c : ReadOnly Ctxt Defs} ->
               Core (Maybe Name)
fromCharName
    = do defs <- read Ctxt
...
export
fromDoubleName : {auto c : ReadOnly Ctxt Defs} ->
               Core (Maybe Name)
fromDoubleName
    = do defs <- read Ctxt
...
export
fromTTImpName : {auto c : ReadOnly Ctxt Defs} ->
                Core (Maybe Name)
fromTTImpName
    = do defs <- read Ctxt
...
export
fromNameName : {auto c : ReadOnly Ctxt Defs} ->
               Core (Maybe Name)
fromNameName
    = do defs <- read Ctxt
...
export
fromDeclsName : {auto c : ReadOnly Ctxt Defs} ->
                Core (Maybe Name)
fromDeclsName
    = do defs <- read Ctxt
...
export
getPrimNames : {auto c : ReadOnly Ctxt Defs} -> Core PrimNames
...
export
getPrimitiveNames : {auto c : ReadOnly Ctxt Defs} -> Core (List Name)
...
export
getSession : {auto c : ReadOnly Ctxt Defs} ->
             Core Session
getSession
    = do defs <- read Ctxt
...
export
checkTimer : {auto c : ReadOnly Ctxt Defs} ->
             Core ()
checkTimer
    = do defs <- read Ctxt
