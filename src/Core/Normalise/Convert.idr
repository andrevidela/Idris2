...
interface Convert tm where
  convert : {auto c : ReadOnly Ctxt Defs} ->
            {vars : Scope} ->
            Defs -> Env Term vars ->
            tm vars -> tm vars -> Core Bool
  convertInf : {auto c : ReadOnly Ctxt Defs} ->
               {vars : Scope} ->
               Defs -> Env Term vars ->
               tm vars -> tm vars -> Core Bool

  convGen : {auto c : ReadOnly Ctxt Defs} ->
            {vars : _} ->
            Ref QVar Int ->
...
mutual
  allConvNF : {auto c : ReadOnly Ctxt Defs} ->
              {vars : _} ->
  ...
  allConv : {auto c : ReadOnly Ctxt Defs} ->
            {vars : _} ->
            Ref QVar Int -> Bool -> Defs -> Env Term vars ->
  ...
  getMatchingVarAlt : {auto c : ReadOnly Ctxt Defs} ->
                      {args, args' : _} ->
                      Defs ->
  ...
  getMatchingVarAlts : {auto c : ReadOnly Ctxt Defs} ->
                       {args, args' : _} ->
                       Defs ->
                       List (Var args, Var args') ->
  ...
  getMatchingVars : {auto c : ReadOnly Ctxt Defs} ->
                    {args, args' : _} ->
                    Defs ->
                    List (Var args, Var args') ->
  ...
  chkSameDefs : {auto c : ReadOnly Ctxt Defs} ->
                {vars : _} ->
                Ref QVar Int -> Bool -> Defs -> Env Term vars ->
                Name -> Name ->
                List (Closure vars) -> List (Closure vars) -> Core Bool
  ...
  chkConvCaseBlock : {auto c : ReadOnly Ctxt Defs} ->
                     {vars : _} ->
  ...
  chkConvHead : {auto c : ReadOnly Ctxt Defs} ->
                {vars : _} ->
                Ref QVar Int -> Bool -> Defs -> Env Term vars ->
  ...
  convPiInfo : {auto c : ReadOnly Ctxt Defs} ->
               {vars : _} ->
               Ref QVar Int -> Bool -> Defs -> Env Term vars ->
  ...
  convBinders : {auto c : ReadOnly Ctxt Defs} ->
                {vars : _} ->
                Ref QVar Int -> Bool -> Defs -> Env Term vars ->
