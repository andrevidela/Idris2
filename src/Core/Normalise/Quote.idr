...
interface Quote tm where
    quote : {auto c : ReadOnly Ctxt Defs} ->
            {vars : Scope} ->
            Defs -> Env Term vars -> tm vars -> Core (Term vars)
    quoteLHS : {auto c : ReadOnly Ctxt Defs} ->
               {vars : Scope} ->
               Defs -> Env Term vars -> tm vars -> Core (Term vars)
    quoteOpts : {auto c : ReadOnly Ctxt Defs} ->
                {vars : Scope} ->
                QuoteOpts -> Defs -> Env Term vars -> tm vars -> Core (Term vars)

    quoteGen : {auto c : ReadOnly Ctxt Defs} ->
               {vars : _} ->
...
mutual
  quoteArg : {auto c : ReadOnly Ctxt Defs} ->
              {bound, free : _} ->
  ...
  quoteArgWithFC : {auto c : ReadOnly Ctxt Defs} ->
                   {bound, free : _} ->
                   Ref QVar Int -> QuoteOpts -> Defs -> Bounds bound ->
  ...
  quoteArgs : {auto c : ReadOnly Ctxt Defs} ->
              {bound, free : _} ->
              Ref QVar Int -> QuoteOpts -> Defs -> Bounds bound ->
  ...
  quoteArgsWithFC : {auto c : ReadOnly Ctxt Defs} ->
                    {bound, free : _} ->
                    Ref QVar Int -> QuoteOpts -> Defs -> Bounds bound ->
  ...
  quoteHead : {auto c : ReadOnly Ctxt Defs} ->
              {bound, free : _} ->
  ...
  quotePi : {auto c : ReadOnly Ctxt Defs} ->
            {bound, free : _} ->
            Ref QVar Int -> QuoteOpts -> Defs -> Bounds bound ->
  ...
  quoteBinder : {auto c : ReadOnly Ctxt Defs} ->
                {bound, free : _} ->
                Ref QVar Int -> QuoteOpts -> Defs -> Bounds bound ->
  ...
  quoteGenNF : {auto c : ReadOnly Ctxt Defs} ->
               {bound, vars : _} ->
               Ref QVar Int -> QuoteOpts ->
               Defs -> Bounds bound ->
...
quoteWithPiGen : {auto _ : ReadOnly Ctxt Defs} ->
                 {bound, vars : _} ->
                 Ref QVar Int -> QuoteOpts -> Defs -> Bounds bound ->
                 Env Term vars -> NF vars -> Core (Term (bound ++ vars))
...
export
quoteWithPi : {auto c : ReadOnly Ctxt Defs} ->
              {vars : Scope} ->
